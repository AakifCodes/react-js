export default function Card1(props) {
  ...
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-transform duration-300 hover:scale-105 group">
